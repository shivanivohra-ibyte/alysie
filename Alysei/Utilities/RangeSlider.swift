...
class RangeSliderTrackLayer: CALayer
{
    ...
    override func draw(in ctx: CGContext) {
        ...
        let rect = CGRect(x: lowerValuePosition, y: 4.0, width: upperValuePosition - lowerValuePosition, height: bounds.height-8)
        ctx.fill(rect)
    }
}
...
class RangeSliderThumbLayer: CALayer {
    ...
    override func draw(in ctx: CGContext) {
        ...
        if highlighted {
//            ctx.setFillColor(UIColor(red: 0.0,
//                         green: 0.0,
//                         blue: 0.0,
//                         alpha: 1).cgColor)
...
class RangeSlider: UIControl {
    ...
    @IBInspectable var minimumValue: Double = 1 {
        willSet(newValue) {
    ...
    @IBInspectable var maximumValue: Double = 5000 {
        willSet(newValue) {
    ...
    @IBInspectable var lowerValue: Double = 1 {
        didSet {
    ...
    @IBInspectable var upperValue: Double = 5000 {
        didSet {
    ...
    @IBInspectable var trackHighlightTintColor: UIColor = APP_THEME_UP
//    (red: 0.0, green: 0.45, blue: 0.94, alpha: 1.0)
        {
        didSet {
            trackLayer.setNeedsDisplay()
        }
    ...
    @IBInspectable var thumbTintColor: UIColor = APP_THEME_UP
//        (red: 245.0, green: 34.0, blue: 89.0, alpha: 1.0)
        {
        didSet {
    ...
    func updateLayerFrames() {
        ...
        trackLayer.frame = bounds.insetBy(dx: 0.0, dy: bounds.height/2.4)
        trackLayer.setNeedsDisplay()
